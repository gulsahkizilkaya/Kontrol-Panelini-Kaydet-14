...
export default function App() {
  ...
  /* Challenge
    ...
    Kaydet butonu aslında kullanıcının widget yapılandırmasını kaydetmez. Göreviniz bunu aşağıdaki şekilde düzeltmektir: 
    	...
    	2. WidgetConfig state, herhangi bir array kaydedilmişse, önceki adımda localStorag
      
      e'a kaydedilen array olarak başlatılmalıdır. Aksi takdirde, DEFAULT_CONFIG olarak başlatılmalıdır.  
